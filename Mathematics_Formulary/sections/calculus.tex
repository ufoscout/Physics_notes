...
$\displaystyle e^x = \sum_{n=0}^{+\infty}\frac{x^n}{n!} = 1 + x + \frac{x^2}{2!} + \frac{x^3}{3!} + ...$ \ \ \ \ It converges for all $x$.

\subsubsection{Logarithm functions}
$\displaystyle \ln(1-x) = -\sum_{n=1}^{+\infty}\frac{x^n}{n} = - x - \frac{x^2}{2} - \frac{x^3}{3} + ...$ \ \ \ \ It converges for $\left|x\right|<1$.

$\displaystyle \ln(1+x) = \sum_{n=1}^{+\infty}(-1)^{n+1}\frac{x^n}{n} = x - \frac{x^2}{2} + \frac{x^3}{3} + ...$ \ \ \ \ It converges for $\left|x\right|<1$.
